...
class PlaylistGenerator:
    ...
    def scan_music_folder(self, folder_path: str, include_subdirs: bool = True) -> List[str]:
        """
        扫描文件夹中的音乐文件
            ...
            if include_subdirs:
                ...
                for file in os.listdir(folder_path):
                    ...
                    if os.path.isfile(file_path) and any(
                        file.lower().endswith(ext) for ext in SUPPORTED_AUDIO_FORMATS
                    ):
                        music_files.append(file_path)
    ...
    def generate_playlist_from_folder(self, folder_path: str, output_file: str,
        ...
        music_files = self.scan_music_folder(folder_path, include_subdirs)
    ...
    def get_folder_analysis(self, folder_path: str, include_subdirs: bool = True) -> Dict:
        """
        分析文件夹内容，返回统计信息
